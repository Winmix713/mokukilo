  ...
  const stats = [
    {
      ...
      description: "Pixel-perfect recreation of Figma designs in Next.js"
    },
    {
      icon: Clock,
      value: "<30s",
      label: "Generation Time",
      description: "From design to production-ready Next.js code"
    },
    {
      icon: Users,
      value: "10,000+",
      label: "Components Generated",
      description: "Trusted by Next.js developers worldwide"
    },
    {
      icon: Award,
      value: "WCAG 2.1",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">
            Proven Next.js Results
          </h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Numbers that speak to the quality and reliability of our 
            AI-powered Figma-to-Next.js generation system.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-4">
              Ready to revolutionize your Next.js design-to-code workflow?
            </h3>
            <p className="text-blue-100 mb-6 leading-relaxed">
              Join thousands of developers and designers who have already transformed 
              their productivity with our AI-powered Next.js component generator.
            </p>
