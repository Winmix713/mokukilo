...
export function ProcessFlow() {
  const phases = [
    ...
    {
      id: 2,
      title: "Next.js Component Processing",
      description: "Generate optimized React components with Next.js patterns, TypeScript support, and modern hooks",
      icon: Code,
      color: "from-indigo-500 to-indigo-600",
      details: ["Next.js Optimization", "TypeScript Generation", "Component Structure", "Hook Integration"]
    },
    {
      id: 3,
      title: "Production-Ready Output",
      description: "Analyze and optimize code for Next.js production deployment with SSR support and performance optimization",
      icon: Layers,
      color: "from-purple-500 to-purple-600",
      details: ["SSR Compatibility", "Performance Optimization", "Responsive Design", "Production Build Ready"]
    }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            3-Phase Next.js Processing Pipeline
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our advanced AI system processes Figma designs through three sophisticated phases 
            to achieve unparalleled accuracy and production-ready Next.js code quality.
          </p>
        </div>
