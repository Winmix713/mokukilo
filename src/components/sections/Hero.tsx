      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm font-medium text-gray-700">Next.js AI-Powered Design-to-Code Revolution</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            From <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Figma</span>
            <br />
            to <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Next.js Code</span>
          </h1>

          <p className="text-xl text-gray-600 mb-10 leading-relaxed">
            Generate pixel-perfect React, HTML, and Vue components from Figma designs with 
            <strong className="text-gray-900"> 95-100% visual accuracy</strong> in under 30 seconds using Next.js.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
            ...
            <Button variant="outline" className="border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:shadow-xl transition-all duration-300">
              View Demo
            </Button>
          </div>
